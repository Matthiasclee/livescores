...
def make_request(url):
    req = Request(url)
    req.add_header("User-Agent", "LiveScores Scoreboard Archiver - https://github.com/Matthiasclee/livescores/blob/master/download_data.py - Contact (maintainer): Matthias Lee <matthias@matthiasclee.com> - Contact (hosting this instance of LiveScores): " + get_secret("contact_info"))
